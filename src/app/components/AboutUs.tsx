  ...
  return (
    <div className=" flex flex-col lg:pt-[177px] ">
      ...
      >
        ...
        <div className="font-inter font-bold lg:text-[18px] text-red-700] text-center lg:pl-[377px] lg:pr-[377px] lg:pt-[33px] lg:pb-[33px] ">
          {" "}
        ...
        <div className="lg:flex justify-between gap-[60px]">
          <div className="flex-1 ">
            <div className=" text-left py-[74px] text-[#000000] lg:text-[18px] lg:pl-[78px]">
          ...
          <div className="lg:flex-1 lg:text-right ">
            <div className=" text-left py-[74px] text-[#000000] lg:text-[18px] lg:pr-[78px]">
              <div className="font-rubik font-semibold lg:text-[35px]">
