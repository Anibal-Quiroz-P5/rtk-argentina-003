...
//     <p className="mt-2 text-lg leading-8 text-gray-600">Escribinos tu mensaje, te contestaremos a la brevedad.</p>
//   </div>
//   <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={handleSubmit} >
//     <div className="grid grid-cols-1 gap-y-6 ">
//       <div>
//         <label  form="firstName"  className="block text-sm font-semibold leading-6 text-gray-900">Nombre</label>
...
//         <label form="company" className="block text-sm font-semibold leading-6 text-gray-900">Area de aplicación de RTK</label>
//         <div className="mt-2.5">
//           <input type="text" name="company" id="company" autoComplete="organization" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" onChange={handleInputChange} />
//         </div>
//       </div>
//       <div className="sm:col-span-2">
//         <label form="email"  className="block text-sm font-semibold leading-6 text-gray-900">Email</label>
//         <div className="mt-2.5">
//           <input type="email" name="email" id="email" autoComplete="email" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" onChange={handleInputChange} />
//         </div>
//       </div>
// {/*       <div className="sm:col-span-2">
...
//       </div> */}
//       <div className="sm:col-span-2">
//         <label form="message"  className="block text-sm font-semibold leading-6 text-gray-900">Mensaje</label>
//         <div className="mt-2.5">
//           <textarea name="message" id="message" rows={4} className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" onChange={handleInputChange} ></textarea>
//         </div>
//       </div>
...
//     </div>
//     <div className="mt-10">
//       <button type="submit" className="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Enviá tu mensaje</button>
//     </div>
//   </form>
// </div>
