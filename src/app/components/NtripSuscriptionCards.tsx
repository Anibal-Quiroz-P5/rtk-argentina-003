        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="font-manrope text-5xl text-center font-bold text-white mb-4">
              Precios del Servicio NTRIP
            </h2>
            {/* <p className="text-gray-300 text-xl text-center leading-6">
              Contáctese para averiguar cobertura del servicio
            </p> */}
          ...
          <div className="flex justify-center">
            <Link
              href="/caracteristics"
              className="inline-block bg-white text-indigo-700 font-semibold px-6 py-3 rounded-xl shadow-md hover:bg-indigo-700 hover:text-white transition duration-300"
            >
          ...
          <div className="space-y-8 lg:grid lg:grid-cols-4 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
            ...
            <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
              <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                ...
                <div className="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-indigo-600">
  <span className="text-2xl font-bold text-indigo-600 transition-all duration-300 group-hover:text-white">
    T
  </span>
</div>
              ...
              <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                <li className="flex items-center space-x-3.5">
                  ...
                  <span> Nuevos usuarios y pruebas iniciales.</span>
                </li>
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>  0% de ahorro   </span>
                </li>
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>Duración 10 días </span>
                </li>
    ...
    M
              ...
              <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>Para usuarios estacionales.</span>
                </li>
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>22% de ahorro</span>
                </li>
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
    ...
    S
              ...
              <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>Para productores medianos </span>
                </li>
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>35% de ahorro</span>
                </li>
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>Duración 180 días </span>
                </li>
              </ul>
              <a
                href="javascript:;"
    ...
    A
              ...
              <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>Para grandes productores.</span>
                </li>
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>55% de ahorro</span>
                </li>
                <li className="flex items-center space-x-3.5">
                  {/* Icon */}
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                  <span>Duración 365 dias </span>
                </li>
              </ul>
              <a
                href="javascript:;"
