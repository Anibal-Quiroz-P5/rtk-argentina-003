    ...
    <div>
      <section className="py-24 relative">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12">
                <h2 className="font-manrope text-5xl text-center font-bold text-white mb-4">Planes de precios disponibles</h2>
                <p className="text-gray-300 text-xl text-center leading-6">3 días gratis de prueba. No requiere tarjeta de crédito</p>
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        ...
                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Plan Diario</h3>
                        <div className="flex items-center justify-center">
                            <span className="font-manrope text-4xl font-medium text-gray-900">U$s 25</span>
                            <span className="text-xl text-gray-500 ml-3">|&nbsp; Por día</span>
                        </div>
                    </div>
                        {/* List */}
                        <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                            <li className="flex items-center space-x-3.5">
                                ...
                                <span>Mensajes RTCM por NTRIP</span>
                            </li>
                            <li className="flex items-center space-x-3.5">
                                {/* Icon */}
                                <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                                <span>RTCM 3.2 - 3.3</span>
                            </li>
                            <li className="flex items-center space-x-3.5">
                                {/* Icon */}
                                <span className="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        ...
                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Plan Mensual</h3>
                        <div className="flex items-center justify-center">
                            <span className="font-manrope text-4xl font-medium text-gray-900">U$s 150</span>
                            <span className="text-xl text-gray-500 ml-3">|&nbsp; Por Mes</span>
                        </div>
                    </div>
                        {/* List */}
                        <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                  ...
                  <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    ...
                    <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Plan Anual</h3>
                    <div className="flex items-center justify-center">
                        <span className="font-manrope text-4xl font-medium text-gray-900">U$s 1500</span>
                        <span className="text-xl text-gray-500 ml-3">|&nbsp; Por Año</span>
                    </div>
                </div>
                    {/* List */}
                    <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
...
export default NtripSuscriptionCards