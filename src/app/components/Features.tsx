...
const Features = () => {
  return (
    ...
    <div className="  bg-gradient-to-b from-custom-green-start to-custom-green-end  ">
      <div
        id="aplicaciones"
        className=" flex flex-col px-7 gap-y-[46px] py-[56px] lg:py-[120px]  lg:gap-y-[80px]   xl:gap-y-[74px] xl:px-[20px] container  lg:w-[92%] xl:w-[62%] 2xl:w-[62%] pt-8  "
      >
        ...
        <div className=" flex flex-col items-center   gap-x-2  sm:flex-row-reverse border-2 border-[#36485C] rounded-3xl  h-auto   xl:h-[444px] 4xl:h-[523px] bg-[#FFFEF0] -mt-[28px]">
          <Image
            src={agricolas}
            alt="Feature 1 image"
