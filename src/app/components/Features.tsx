...
const Features = () => {
  return (
    ...
    <div className="  bg-gradient-to-b from-custom-green-start to-custom-green-end  ">
      <div
        id="aplicaciones"
        className="flex flex-col px-7 gap-y-[46px] py-[56px] lg:py-[120px]  lg:gap-y-[80px]   2xl:gap-y-[74px] 2xl:px-[20px] lg:container  lg:w-[92%] 2xl:w-[62%] pt-8  "
      >
        ...
        <div className="flex flex-col items-center   gap-x-2  sm:flex-row-reverse border-2 border-[#36485C] rounded-3xl lg:h-[510px] h-auto 2xl:h-[444px] 4xl:h-[523px] bg-[#FFFEF0] -mt-[28px]">          
          <Image
            ...
            className="hidden w-1/2  sm:block pr-12 4xl:h-[90%]"            //   ESTA IMAGEN "NO" APARECE EN CELULARES, SOLO APARECE EN TAMAÑOS MAYORES A "sm"
          />
        ...
        <div className="flex flex-col items-center gap-x-2  sm:flex-row-reverse border-2 border-[#36485C] rounded-3xl lg:h-[510px] h-auto 2xl:h-[444px] 4xl:h-[523px] bg-[#FFFEF0]">          <Image
            src={drone}
            alt="Feature 1 image"
            className="hidden w-1/2  sm:block pr-12 4xl:h-[90%]"            //   ESTA IMAGEN "NO" APARECE EN CELULARES, SOLO APARECE EN TAMAÑOS MAYORES A "sm"
          />
        ...
        <div className="flex flex-col items-center gap-x-2  sm:flex-row-reverse border-2 border-[#36485C] rounded-3xl lg:h-[510px] h-auto 2xl:h-[444px] 4xl:h-[523px] bg-[#FFFEF0]">
          <Image
            src={agricultura}
            alt="Feature 1 image"
            className="hidden w-1/2  sm:block pr-12 4xl:h-[90%]"            //   ESTA IMAGEN "NO" APARECE EN CELULARES, SOLO APARECE EN TAMAÑOS MAYORES A "sm"
